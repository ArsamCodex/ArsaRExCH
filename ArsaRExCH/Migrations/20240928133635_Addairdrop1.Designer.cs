...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20240928133635_Addairdrop1")]
    partial class Addairdrop1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 9, 28, 14, 36, 34, 844, DateTimeKind.Local).AddTicks(9519),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 9, 28, 14, 36, 34, 844, DateTimeKind.Local).AddTicks(9568),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 9, 28, 14, 36, 34, 844, DateTimeKind.Local).AddTicks(9574),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
