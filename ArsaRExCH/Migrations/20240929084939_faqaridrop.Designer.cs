...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20240929084939_faqaridrop")]
    partial class faqaridrop
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 9, 29, 9, 49, 38, 160, DateTimeKind.Local).AddTicks(5800),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 9, 29, 9, 49, 38, 160, DateTimeKind.Local).AddTicks(5851),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 9, 29, 9, 49, 38, 160, DateTimeKind.Local).AddTicks(5855),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
