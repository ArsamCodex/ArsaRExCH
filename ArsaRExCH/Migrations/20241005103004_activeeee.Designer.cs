...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241005103004_activeeee")]
    partial class activeeee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 10, 5, 11, 30, 3, 836, DateTimeKind.Local).AddTicks(8231),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 10, 5, 11, 30, 3, 836, DateTimeKind.Local).AddTicks(8280),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 10, 5, 11, 30, 3, 836, DateTimeKind.Local).AddTicks(8284),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
