...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241004001715_bitpooll1121")]
    partial class bitpooll1121
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 10, 4, 1, 17, 13, 929, DateTimeKind.Local).AddTicks(2543),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 10, 4, 1, 17, 13, 929, DateTimeKind.Local).AddTicks(2594),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 10, 4, 1, 17, 13, 929, DateTimeKind.Local).AddTicks(2598),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
