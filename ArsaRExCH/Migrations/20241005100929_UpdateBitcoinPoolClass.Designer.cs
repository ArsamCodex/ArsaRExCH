...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241005100929_UpdateBitcoinPoolClass")]
    partial class UpdateBitcoinPoolClass
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 10, 5, 11, 9, 28, 236, DateTimeKind.Local).AddTicks(5135),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 10, 5, 11, 9, 28, 236, DateTimeKind.Local).AddTicks(5180),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 10, 5, 11, 9, 28, 236, DateTimeKind.Local).AddTicks(5183),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
