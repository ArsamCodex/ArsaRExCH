...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241007225406_livevhatadded")]
    partial class livevhatadded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 10, 7, 23, 54, 5, 526, DateTimeKind.Local).AddTicks(1081),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 10, 7, 23, 54, 5, 526, DateTimeKind.Local).AddTicks(1125),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 10, 7, 23, 54, 5, 526, DateTimeKind.Local).AddTicks(1128),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
