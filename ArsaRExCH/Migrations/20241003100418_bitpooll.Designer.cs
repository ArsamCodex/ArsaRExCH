...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241003100418_bitpooll")]
    partial class bitpooll
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 10, 3, 11, 4, 17, 349, DateTimeKind.Local).AddTicks(7909),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 10, 3, 11, 4, 17, 349, DateTimeKind.Local).AddTicks(7958),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 10, 3, 11, 4, 17, 349, DateTimeKind.Local).AddTicks(7963),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
            ...
            modelBuilder.Entity("ArsaRExCH.Model.BitcoinPoolTransactions", b =>
                {
                    b.HasOne("ArsaRExCH.Model.BitcoinPool", "bitcoin")
                        .WithMany("bitcoinPoolTransactions")
                        .HasForeignKey("BitcoinPoolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("bitcoin");
                });
            ...
            modelBuilder.Entity("ArsaRExCH.Model.BitcoinPool", b =>
                {
                    b.Navigation("bitcoinPoolTransactions");
                });
