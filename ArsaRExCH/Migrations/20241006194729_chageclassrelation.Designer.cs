...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241006194729_chageclassrelation")]
    partial class chageclassrelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 10, 6, 20, 47, 28, 751, DateTimeKind.Local).AddTicks(5680),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 10, 6, 20, 47, 28, 751, DateTimeKind.Local).AddTicks(5737),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 10, 6, 20, 47, 28, 751, DateTimeKind.Local).AddTicks(5740),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
