...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241013103343_owwwww")]
    partial class owwwww
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 10, 13, 11, 33, 42, 298, DateTimeKind.Local).AddTicks(9523),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 10, 13, 11, 33, 42, 298, DateTimeKind.Local).AddTicks(9570),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 10, 13, 11, 33, 42, 298, DateTimeKind.Local).AddTicks(9573),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
