...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241001200119_replynnf")]
    partial class replynnf
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 10, 1, 21, 1, 18, 264, DateTimeKind.Local).AddTicks(146),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 10, 1, 21, 1, 18, 264, DateTimeKind.Local).AddTicks(222),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 10, 1, 21, 1, 18, 264, DateTimeKind.Local).AddTicks(228),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
