...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20240930005706_repltuserid")]
    partial class repltuserid
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 9, 30, 1, 57, 5, 122, DateTimeKind.Local).AddTicks(627),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 9, 30, 1, 57, 5, 122, DateTimeKind.Local).AddTicks(673),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 9, 30, 1, 57, 5, 122, DateTimeKind.Local).AddTicks(677),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
