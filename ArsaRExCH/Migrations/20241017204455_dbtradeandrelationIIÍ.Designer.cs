...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241017204455_dbtradeandrelationIIÍ")]
    partial class dbtradeandrelationIIÍ
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 10, 17, 21, 44, 54, 683, DateTimeKind.Local).AddTicks(9152),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 10, 17, 21, 44, 54, 683, DateTimeKind.Local).AddTicks(9200),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 10, 17, 21, 44, 54, 683, DateTimeKind.Local).AddTicks(9203),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
