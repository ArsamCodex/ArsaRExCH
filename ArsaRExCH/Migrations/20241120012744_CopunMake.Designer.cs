...
namespace ArsaRExCH.Migrations
{
    ...
    [Migration("20241120012744_CopunMake")]
    partial class CopunMake
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArsaRExCH.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d00d2b81-e9d2-419c-8765-7e64aaa07dc5",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0f3931cc-0ab7-4e39-832d-38de9a6c5515",
                            ...
                            SecurityStamp = "39b825a0-606f-4df9-8b35-a59e21d28be4",
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PairID = 1,
                            ListPrice = 100.0,
                            ListedDate = new DateTime(2024, 11, 20, 1, 27, 43, 560, DateTimeKind.Local).AddTicks(8602),
                            NetworkName = "BTC",
                            PaiName = "BTC"
                        },
                        new
                        {
                            PairID = 2,
                            ListPrice = 200.0,
                            ListedDate = new DateTime(2024, 11, 20, 1, 27, 43, 560, DateTimeKind.Local).AddTicks(8652),
                            NetworkName = "BNB",
                            PaiName = "BNB"
                        },
                        new
                        {
                            PairID = 3,
                            ListPrice = 300.0,
                            ListedDate = new DateTime(2024, 11, 20, 1, 27, 43, 560, DateTimeKind.Local).AddTicks(8655),
                            NetworkName = "ETH",
                            PaiName = "ETH"
                        });
                });
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Prop.PrepPir", b =>
                {
                    b.Property<int>("PrepPirId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PrepPirId"));
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Prop.PropUser", b =>
                {
                    ...
                    b.Property<string>("MyUniqueFlag")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ArsaRExCH.Model.Prop.TransferBetweenAcounts", b =>
                {
                    b.Property<int>("TransferBetweenAcountsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TransferBetweenAcountsId"));
                    ...
                    b.HasKey("TransferBetweenAcountsId");

                    b.ToTable("transferBetweenAcounts");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "bca9892e-61c8-45da-958d-ddad1f38a609",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "d00d2b81-e9d2-419c-8765-7e64aaa07dc5",
                            RoleId = "bca9892e-61c8-45da-958d-ddad1f38a609"
                        });
                });
